...
class MediatedLinkedRdfSourcesAsyncRdfIterator extends LinkedRdfSourcesAsyncRdfIterator_1.LinkedRdfSourcesAsyncRdfIterator {
    ...
    async getSource(link, handledDatasets) {
        ...
        this.aggregatedStore?.setBaseMetadata(metadata, false);
    ...
    startIterator(startSource, firstPage) {
        if (this.aggregatedStore && !this.aggregatedStore.containedSources.has(startSource.link.url)) {
            ...
            const stream = startSource.source.match(DF.variable('s'), DF.variable('p'), DF.variable('o'), DF.variable('g'), this.context);
