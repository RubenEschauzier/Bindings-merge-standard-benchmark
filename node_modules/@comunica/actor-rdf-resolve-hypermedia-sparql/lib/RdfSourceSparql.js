...
class RdfSourceSparql {
    constructor(url, context, mediatorHttp, forceHttpGet, cacheSize) {
        this.url = url;
    ...
    static replaceBlankNodes(pattern) {
        ...
        const result = (0, rdf_terms_1.mapTermsNested)(pattern, term => {
    ...
    static patternToSelectQuery(pattern) {
        ...
        return (0, sparqlalgebrajs_1.toSparql)(RdfSourceSparql.FACTORY.createProject(RdfSourceSparql.patternToBgp(pattern), variables), { sparqlStar: true });
    }
    /**
    ...
    match(subject, predicate, object, graph) {
        ...
        const quads = new asynciterator_1.TransformIterator(async () => this
            .queryBindings(this.url, selectQuery), { autoStart: false })
            .transform({
            map: (bindings) => (0, rdf_terms_1.mapTermsNested)(pattern, (value) => {
