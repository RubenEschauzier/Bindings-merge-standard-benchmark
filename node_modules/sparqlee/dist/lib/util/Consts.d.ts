export declare type KnownLiteralTypes = TypeAlias | TypeURL;
...
export declare const RegularOperators: Set<string>;
export declare const SpecialOperators: Set<string>;
...
export declare const SetFunctions: Set<SetFunction>;
export declare type NamedOperator = TypeURL.XSD_STRING | TypeURL.XSD_FLOAT | TypeURL.XSD_DOUBLE | TypeURL.XSD_DECIMAL | TypeURL.XSD_INTEGER | TypeURL.XSD_DATE_TIME | TypeURL.XSD_DATE | TypeURL.XSD_BOOLEAN | TypeURL.XSD_TIME | TypeURL.XSD_DURATION | TypeURL.XSD_DAY_TIME_DURATION | TypeURL.XSD_YEAR_MONTH_DURATION;
