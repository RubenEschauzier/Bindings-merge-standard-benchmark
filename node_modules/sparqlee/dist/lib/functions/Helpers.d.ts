...
export declare class Builder {
    ...
    onUnaryTyped<T>(type: ArgumentType, op: (context: ICompleteSharedContext) => (val: T) => Term, addInvalidHandling?: boolean): Builder;
    onBinary<L extends Term, R extends Term>(types: ArgumentType[], op: (context: ICompleteSharedContext) => (left: L, right: R) => Term, addInvalidHandling?: boolean): Builder;
    onBinaryTyped<L, R>(types: ArgumentType[], op: (context: ICompleteSharedContext) => (left: L, right: R) => Term, addInvalidHandling?: boolean): Builder;
    onTernaryTyped<A1, A2, A3>(types: ArgumentType[], op: (context: ICompleteSharedContext) => (a1: A1, a2: A2, a3: A3) => Term, addInvalidHandling?: boolean): Builder;
    onTernary<A1 extends Term, A2 extends Term, A3 extends Term>(types: ArgumentType[], op: (context: ICompleteSharedContext) => (a1: A1, a2: A2, a3: A3) => Term, addInvalidHandling?: boolean): Builder;
    onQuaternaryTyped<A1, A2, A3, A4>(types: ArgumentType[], op: (context: ICompleteSharedContext) => (a1: A1, a2: A2, a3: A3, a4: A4) => Term, addInvalidHandling?: boolean): Builder;
    onTerm1(op: (context: ICompleteSharedContext) => (term: Term) => Term, addInvalidHandling?: boolean): Builder;
    ...
    onLiteral1<T>(op: (context: ICompleteSharedContext) => (lit: E.Literal<T>) => Term, addInvalidHandling?: boolean): Builder;
